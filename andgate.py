...
#         self.input1 = GUIPin(canvas, window, x - self.width/2, y + self.height/4, self.pin_radius, self.andgate.id, is_input=True, draggable=False)
#         self.input2 = GUIPin(canvas, window, x - self.width/2, y - self.height/4, self.pin_radius, self.andgate.id, is_input=True, draggable=False)
